...
id = ifca; type = OpenStack; host = https://api.cloud.ifca.es:5000; username = %s; password = %s; tenant = VO:eosc-synergy.eu; tenant_domain_id = None; domain = EOSC-Synergy; auth_version = 3.x_password
EOF
