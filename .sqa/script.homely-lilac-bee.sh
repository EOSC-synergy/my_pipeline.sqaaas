...
id = ifca; type = OpenStack; host = https://api.cloud.ifca.es:5000; username = %s; password = %s; tenant = eosc-synergy; domain = default; auth_version = 3.x_password
EOF
